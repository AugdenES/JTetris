...
### 1. Console 
#### First, cd into the correct directory where TetrisApp.java and the rest of the files from  __JTetris__ are located. Then, type the following into the command line:
